...
| | क्षमता | विवरण |
|---|---|---|
| 🪄 | **काम करने वाला AI** | एडमिन बस **सामान्य भाषा में कहें** — “इसे 2 घंटे म्यूट करो”, “कैप्चा चालू करो”, “पोल: लंच?”, “नाइट मोड 23:00-06:00” — और बॉट कर देता है: 30+ व्हाइटलिस्टेड कार्रवाइयाँ, हर एक सर्वर पर दोबारा जाँची जाती है (केवल एडमिन, संरक्षित लक्ष्य, प्रति संदेश अधिकतम 3) रसीद के साथ · साथ में `/imagine`, `/approve`, `/aiquota`, welcome में URL बटन |
...
| 🧹 | **संदेश स्वच्छता** | **कीवर्ड फ़िल्टर** (`/filter`), **शब्द ब्लॉकलिस्ट** (`/block`) तुरंत हटाने के साथ, इनवाइट लिंक हटाना · एक-टैप मॉडरेशन पैनल `/mp` (एफ़ेमरल) |
| 🤝 | **फ़ेडरेशन** | **ग्रुपों के बीच साझा बैन सूची**: हर ग्रुप में `/newfed` → `/joinfed` · `/fban` एक साथ सब जगह बैन करता है और जॉइन करते ही हटा देता है |
| 🌍 | **अनुवाद** | `/tr` (reply) से संदेश का अनुवाद · `/bridge de` बहुभाषी ग्रुपों में विदेशी संदेशों का स्वतः अनुवाद |
| 📊 | **आँकड़े व बुनियादी** | `/stats` गतिविधि चार्ट व सबसे सक्रिय सदस्य · `/recall` संदेश खोज · `/afk` · `/ping` `/uptime` `/about` `/admins` `/invite` |
| 🔎 | **इनलाइन व अधिक** | `@botname सवाल` — **किसी भी चैट से** AI से पूछें · AI **खुद को जानता है** (वर्शन, कमांड, चैट सेटिंग) · **स्व-अपडेट** (`/update`, `AUTO_UPDATE=true`) · चैनलों के लिए `/subscription` Stars सब्सक्रिप्शन |
| 🌙 | **नाइट मोड व समय क्षेत्र** | `/night 23:00-06:00` चैट के स्थानीय समय (`/settz Asia/Kolkata`) में रोज़ ग्रुप लॉक करता है, घोषणाओं और सटीक अनुमति बहाली के साथ |
...
| 💼 | **Business ऑटो-ट्राइएज** | हर ग्राहक चैट को AI जवाब **और स्वतः लेबल** (मंशा, तात्कालिकता, एक-पंक्ति सारांश) मिलता है, बिना अतिरिक्त AI कॉल · `/leads [लेबल]` मालिक के DM में प्राथमिकता इनबॉक्स · मालिक की कार्रवाइयाँ अब किसी भी ग्रुप को दूर से कॉन्फ़िगर करती हैं और बताती हैं किन प्रोवाइडर के पास key है (सिर्फ़ नाम) |
| 🧭 | **विज़ार्ड, डैशबोर्ड व ops** | नए ग्रुप के लिए `/setup` एक-टैप प्रीसेट (समुदाय / सख़्त / घोषणाएँ) · केवल-पढ़ने वाला स्टैट्स डैशबोर्ड (सिर्फ़ मालिक, `initData` से प्रमाणित) + `/healthz` + Prometheus `/metrics` · `/autobackup` डेटाबेस समय-समय पर DM में भेजता है · `/react` `/clearreactions` `/autoreact` · सुझाए पोस्ट की मॉडरेशन · General टॉपिक नियंत्रण |
