...
export const en = {
  ...
  "help.more": "🧩 <b>More tools</b>\n/filter /block — auto-replies &amp; blocked words\n/mp — one-tap mod panel (by reply)\n/newfed /joinfed /fban — cross-group ban federations\n/stats /recall — activity charts &amp; message search\n/afk — away status · /tr &amp; /bridge — translation\nInline: type @botname + a question in any chat\n/about /ping /uptime · owner: /update",
} as const;
