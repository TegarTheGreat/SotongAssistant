...
export const en = {
  ...
  "help.more": "🧩 <b>More tools</b>\n/filter /block /antilink /allowlink — auto-replies, blocked words &amp; link policy\n/mp — one-tap mod panel · /warnmode — warn penalty · /promote /demote /title\n/night &amp; /settz — nightly auto-lockdown · /disable — command management\n/newfed /joinfed /fban — ban federations · /tagall — mention active members\n/welcome &amp; /goodbye with {mention} {count} placeholders · NSFW filter in /settings\n/stats /recall — analytics · /afk · /tr &amp; /bridge — translation\n/newtopic /closetopic — forum topics · Inline: @botname + a question anywhere\n/about /ping /uptime · owner: /update",
