...
export const ru = {
  ...
  "help.more": "🧩 <b>Ещё инструменты</b>\n/filter /block — автоответы и запрещённые слова\n/mp — панель модерации в один тап (ответом)\n/newfed /joinfed /fban — федерации банов между группами\n/stats /recall — графики активности и поиск сообщений\n/afk — статус отсутствия · /tr и /bridge — перевод\nInline: @имябота + вопрос в любом чате\n/about /ping /uptime · владелец: /update",
