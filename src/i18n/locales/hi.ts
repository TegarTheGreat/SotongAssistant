...
export const hi = {
  ...
  "help.more": "🧩 <b>और उपकरण</b>\n/filter /block /antilink /allowlink — स्वतः जवाब, ब्लॉक शब्द और लिंक नीति\n/mp — मॉडरेशन पैनल · /warnmode — चेतावनी सज़ा · /promote /demote /title\n/night और /settz — रात का ऑटो-लॉक · /disable — कमांड प्रबंधन\n/newfed /joinfed /fban — बैन फ़ेडरेशन · /tagall — सक्रिय सदस्यों को टैग करें\n/welcome और /goodbye ({mention} {count} प्लेसहोल्डर) · /settings में NSFW फ़िल्टर\n/stats /recall — विश्लेषण · /afk · /tr और /bridge — अनुवाद\n/newtopic /closetopic — फ़ोरम टॉपिक · इनलाइन: कहीं भी @botname + सवाल\n/about /ping /uptime · मालिक: /update",
