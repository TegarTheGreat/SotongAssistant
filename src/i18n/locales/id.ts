...
export const id = {
  ...
  "help.more": "🧩 <b>Alat lainnya</b>\n/filter /block /antilink /allowlink — balasan otomatis, kata terblokir &amp; kebijakan tautan\n/mp — panel moderasi · /warnmode — hukuman warn · /promote /demote /title\n/night &amp; /settz — kunci malam otomatis · /disable — manajemen perintah\n/newfed /joinfed /fban — federasi ban · /tagall — sebut anggota aktif\n/welcome &amp; /goodbye dengan placeholder {mention} {count} · filter NSFW di /settings\n/stats /recall — analitik · /afk · /tr &amp; /bridge — terjemahan\n/newtopic /closetopic — topik forum · Inline: @namabot + pertanyaan di mana pun\n/about /ping /uptime · pemilik: /update",
