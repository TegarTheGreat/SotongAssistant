...
export const fa = {
  ...
  "help.more": "🧩 <b>ابزارهای بیشتر</b>\n/filter /block — پاسخ خودکار و واژه‌های مسدود\n/mp — پنل مدیریت تک‌ضربه (با ریپلای)\n/newfed /joinfed /fban — فدراسیون‌های بن بین گروه‌ها\n/stats /recall — نمودار فعالیت و جستجوی پیام\n/afk — وضعیت غیبت · /tr و /bridge — ترجمه\nاینلاین: در هر چتی ‎@نام_بات + سؤال\n/about /ping /uptime · مالک: /update",
